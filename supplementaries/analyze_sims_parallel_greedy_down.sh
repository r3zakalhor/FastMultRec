...
do
	stats_out=$dir_name/stats_out_fix_loss_MV2_d${dupcost}_l1_t70_GV2_1.csv
	echo $str > $stats_out
done
...
do
	...
	if [ -s $dir_name/$newname/s_tree.trees ]; then
		...
		./segmentalreconcile_MV2 -d 2 -l 1 -gf $dir_name/$newname/$gen_file_name -sf $dir_name/$newname/s_tree.newick -o $dir_name/$newname/out_greedydown2.txt -al fastgreedy&
		./segmentalreconcile_MV2 -d 3 -l 1 -gf $dir_name/$newname/$gen_file_name -sf $dir_name/$newname/s_tree.newick -o $dir_name/$newname/out_greedydown3.txt -al fastgreedy&
		./segmentalreconcile_MV2 -d 4 -l 1 -gf $dir_name/$newname/$gen_file_name -sf $dir_name/$newname/s_tree.newick -o $dir_name/$newname/out_greedydown4.txt -al fastgreedy&
		./segmentalreconcile_MV2 -d 5 -l 1 -gf $dir_name/$newname/$gen_file_name -sf $dir_name/$newname/s_tree.newick -o $dir_name/$newname/out_greedydown5.txt -al fastgreedy&
		./segmentalreconcile_MV2 -d 10 -l 1 -gf $dir_name/$newname/$gen_file_name -sf $dir_name/$newname/s_tree.newick -o $dir_name/$newname/out_greedydown10.txt -al fastgreedy&
		./segmentalreconcile_MV2 -d 20 -l 1 -gf $dir_name/$newname/$gen_file_name -sf $dir_name/$newname/s_tree.newick -o $dir_name/$newname/out_greedydown20.txt -al fastgreedy&
		./segmentalreconcile_MV2 -d 30 -l 1 -gf $dir_name/$newname/$gen_file_name -sf $dir_name/$newname/s_tree.newick -o $dir_name/$newname/out_greedydown30.txt -al fastgreedy&
		./segmentalreconcile_MV2 -d 50 -l 1 -gf $dir_name/$newname/$gen_file_name -sf $dir_name/$newname/s_tree.newick -o $dir_name/$newname/out_greedydown50.txt -al fastgreedy&
		./segmentalreconcile_MV2 -d 70 -l 1 -gf $dir_name/$newname/$gen_file_name -sf $dir_name/$newname/s_tree.newick -o $dir_name/$newname/out_greedydown70.txt -al fastgreedy&
		./segmentalreconcile_MV2 -d 100 -l 1 -gf $dir_name/$newname/$gen_file_name -sf $dir_name/$newname/s_tree.newick -o $dir_name/$newname/out_greedydown100.txt -al fastgreedy&
		...
		do
			...
			greedy_file="out_greedydown${dupcost}.txt"
			...
			file="$dir_name/$newname/out_greedydown${dupcost}.txt"
			j=1
			greedy_cost=-1
			while read -r line; do
				if [ "$j" -eq 2 ]; then
