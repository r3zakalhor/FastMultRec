...
do
	./simphy -sb f:0.000001 -gb u:-18,-16 -gt f:0.0 -gg f:0.0 -gp f:0.0 -ld ln:gb,3 -lb f:ld -lt f:0.0 -lg f:0.0 -rs 1 -rl f:99 -rg 1 -o $dir_name -sp f:2 -su f:0.00001 -sg f:1 -sl U:20,50 -st f:1000000 -om 1 -v 3 -od 1 -op 1 -oc 1 -on 1 -ol 1 -cs $RANDOM
	cd $dir_name
	newname="sim_${i}"
	rm -r $newname
	mv 1 $newname
