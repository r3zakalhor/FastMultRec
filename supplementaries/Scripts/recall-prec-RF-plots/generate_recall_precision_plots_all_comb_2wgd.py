...
recall_files_inferred = [
    "recall-2W-WGD-improvedtrees-bootstrap-b1000-2NumApp-t50-t200-Avg.csv", "recall-2W-WGD-improvedtrees-bootstrap-b1000-2NumApp-t80-t200-Avg.csv"]

precision_files_inferred = [
    "precision-2W-WGD-improvedtrees-bootstrap-b1000-2NumApp-t50-t200-Avg.csv", "precision-2W-WGD-improvedtrees-bootstrap-b1000-2NumApp-t80-t200-Avg.csv"]

recall_files_true = [
    "recall-2W-WGD-true-t50-t200-Avg.csv", "recall-2W-WGD-true-t80-t200-Avg.csv"]

precision_files_true = [
    "precision-2W-WGD-true-t50-t200-Avg.csv", "precision-2W-WGD-true-t80-t200-Avg.csv"]
...
def plot_page(fig, dup_cost, recall_files, precision_files, inferred):
    axs = fig.subplots(2, 2)  # 2x2 grid
    axs = axs.ravel()

    for idx, (recall_file, precision_file) in enumerate(zip(recall_files, precision_files)):
        ax_precision = axs[idx * 2]     # First column
        ax_recall = axs[idx * 2 + 1]    # Second column
        ...
        ax_precision.set_title(threshold_labels[idx], fontsize=20)
        ...
        ax_recall.set_xticklabels(x_labels, rotation=90)
