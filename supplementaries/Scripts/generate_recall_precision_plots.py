...
def plot_linear(csv_file1):
    ...
    for name in names1:
        ...
        if name == 'out_lca_improvedTreesDL_b1000_90_1_recall':
            recall = True
        if name == 'out_lca_improvedTreesDL_b1000_90_1_recall' or name == 'out_lca_improvedTreesDL_b1000_90_1_precision' or name == 'lca_FP':
            plt.plot(x_labels1, y_values, marker='o', label=f'LCA (1 WGD)', linestyle='-', color='#ff000e')  # Solid line for 'lca_recall'
        elif name == 'out_greedydown100_improvedTreesDL_b1000_90_1_recall' or name == 'out_greedydown100_improvedTreesDL_b1000_90_1_precision' or name == 'greedydown100_FP':
